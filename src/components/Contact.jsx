...
import './Contact.css'
import contactChar from '../assets/images/contact-character.png'
    ...
    <section className="contact page-section">
      ...
      <div className="contact-content">
        ...
        <div className="page-nav">
          <Link to="/project" className="page-nav-btn page-nav-btn--back">← Project</Link>
        </div>
      </div>
      <div className="contact-image">
        <img src={contactChar} alt="Daffa contact character" />
      </div>
    </section>
  )
}
